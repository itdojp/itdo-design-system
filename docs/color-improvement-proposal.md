...
```css
/* メインカラー（UI要素用） */
--color-primary: #8b6f47;        /* Warm Brown - メインボタン、重要な要素 */
--color-primary-hover: #78522b;  /* Darker Brown - ホバー状態 */
--color-primary-light: #fdf8f6;  /* Light Cream - 背景 */
...
/* ニュートラルカラー */
--color-text-primary: #3e2723;   /* Dark Brown - メインテキスト */
--color-text-secondary: #a18072; /* Medium Brown - サブテキスト */
--color-border: #e0cec7;         /* Light Brown - ボーダー */
--color-background: #fdf8f6;     /* Cream - 背景 */
```

### 各案の特徴比較

| 項目 | プロフェッショナルブルー案 | ウォームブラウン案 |
|------|--------------------------|-------------------|
| **印象** | 信頼性・専門性 | 温かみ・親しみやすさ |
| **オレンジとの相性** | 補色関係で調和◎ | 同系色で自然な調和◎ |
| **視認性** | 高コントラスト | やや柔らかめ |
| **長時間使用** | 疲れにくい | より目に優しい |
| **差別化** | 一般的 | ユニーク |
| **適用分野** | B2B、エンタープライズ | B2C、コミュニティ |

## 🎯 最終推奨

用途に応じて選択：
- **B2B/エンタープライズ系**: プロフェッショナルブルー案
- **B2C/コミュニティ系**: ウォームブラウン案
